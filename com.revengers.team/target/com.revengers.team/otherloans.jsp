...
<form action="InsuranceServlet" method="get">
<div style="text-align: center;">
    <input type="submit" value="View Medical Policy" style="border: none; color:wheat; font-weight: bold; margin-top: 10px;padding: 10px 10px;background-color: #7b312d; border-radius: 5px; font-size: 20px;">
</div>
</form>	
<br>
<form action="AlInsuranceServlet" method="get">
<div style="text-align: center;">
    <input type="submit" value="View AirLine Policy" style="border: none; color:wheat; font-weight: bold; margin-top: 10px;padding: 10px 10px;background-color: #7b312d; border-radius: 5px; font-size: 20px; ">
</div>
</form>	
<br>
