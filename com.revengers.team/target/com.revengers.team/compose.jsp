...
<h3 align="center" style="margin-top: 20px; color: wheat; font-size: 25px">Compose New Mail:</h3>
<form action="CreatedServletEmail" method="Post">
<table align="center" style="margin-top: 10px;">	
	<tr>
    <th>From:</th>
    <th>
        <select name="sender" style="border: none; color:#7b312d; font-weight: bold;">
	...
	<tr>
	<th>To:</th>
	<th><input type="text" name="recipient"></th>
	</tr>
	<tr>
	<th>Subject:</th>
	...
	<tr>
	<th>Message:</th>
	<th><textarea name="message" rows="5" cols="50"></textarea></th>
	</tr>

</table>
<div style="text-align: center;">
    <input type="submit" value="Send" style="border: none; color:wheat; font-weight: bold; margin-top: 10px;padding: 5px 5px;background-color: #7b312d; border-radius: 5px;">
</div>
</form>	
