...
<form action="viewinbox.jsp" method="get">
...
<div style="text-align: center;">
    <input type="submit" value="View Inbox" style="border: none; color:wheat; font-weight: bold; margin-top: 10px;padding: 5px 5px;background-color: #7b312d; border-radius: 5px;">
</div>
</form>	
